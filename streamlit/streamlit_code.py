...
Title_html = """
    ...
    <div class="title">
        <h1>Toll Tax Calculation With Vehicle Type And License Plate Recognition</h1>
    </div>
    """
...
def drawPred(classId, conf, left, top, right, bottom, frame,classes):
    ...
    cv2.putText(frame, label, (left, top-10), cv2.FONT_HERSHEY_SIMPLEX, 3, (0,0,0), 3)
...
def load_net():
    modelConfiguration_1 = "New_weights/type/yolov3_custom.cfg"
    modelWeights_1 = "New_weights/type/yolov3_custom_last.weights"
    classesFile_1 = "New_weights/type/obj.names"
...
#     classesFile_2 = "New_weights/lp/obj.names"
    ...
    modelConfiguration_2 = "New_weights/lp/yolov3_o1_custom.cfg"
    modelWeights_2 = "New_weights/lp/yolov3_o1_custom_last.weights"
    classesFile_2 = "New_weights/lp/obj.names"


    modelConfiguration_3 = "New_weights/char/yolov3_custom.cfg"
    modelWeights_3 = "New_weights/char/yolov3_custom_last.weights"
    classesFile_3 = "New_weights/char/obj.names"
...
def detect_objects(our_image,log_file):
    ...
    while cv2.waitKey(1) < 0:
        ...
        # try:
        #     st.subheader("Detected objects: " + ''.join(label2))
        # except IndexError:
        #     st.write("Nothing detected")
        # st.image(cropped1,width=300)
        # ,channels='BGR'
        st.text("")
